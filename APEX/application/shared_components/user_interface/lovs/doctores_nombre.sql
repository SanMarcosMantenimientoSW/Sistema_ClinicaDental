prompt --application/shared_components/user_interface/lovs/doctores_nombre
begin
--   Manifest
--     DOCTORES.NOMBRE
--   Manifest End
...
wwv_flow_imp_shared.create_list_of_values(
 p_id=>wwv_flow_imp.id(18332121320249659756)
,p_lov_name=>'DOCTORES.NOMBRE'
,p_source_type=>'TABLE'
,p_location=>'LOCAL'
,p_query_table=>'DOCTORES'
