...
wwv_flow_imp_shared.create_template(
 p_id=>wwv_flow_imp.id(18322067714483071775)
,p_theme_id=>42
,p_name=>'Login'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(18322068012992071775)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(18322068351580071775)
,p_page_template_id=>wwv_flow_imp.id(18322067714483071775)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(18322068633480071775)
,p_page_template_id=>wwv_flow_imp.id(18322067714483071775)
,p_name=>'Body Header'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(18322068901990071776)
,p_page_template_id=>wwv_flow_imp.id(18322067714483071775)
,p_name=>'Body Footer'
