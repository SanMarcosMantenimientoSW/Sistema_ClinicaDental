...
wwv_flow_imp_shared.create_template(
 p_id=>wwv_flow_imp.id(18322057140915071770)
,p_theme_id=>42
,p_name=>'Drawer'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(18322057462143071770)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(18322057796286071770)
,p_page_template_id=>wwv_flow_imp.id(18322057140915071770)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(18322058021808071771)
,p_page_template_id=>wwv_flow_imp.id(18322057140915071770)
