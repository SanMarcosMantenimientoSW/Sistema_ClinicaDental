...
wwv_flow_imp_shared.create_template(
 p_id=>wwv_flow_imp.id(18322086327216071782)
,p_theme_id=>42
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(18322086612198071782)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(18322086948385071783)
,p_page_template_id=>wwv_flow_imp.id(18322086327216071782)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(18322087246488071783)
,p_page_template_id=>wwv_flow_imp.id(18322086327216071782)
