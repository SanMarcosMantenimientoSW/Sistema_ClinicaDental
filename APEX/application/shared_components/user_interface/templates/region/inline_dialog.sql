...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(18322135236001071802)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(18322135504618071802)
,p_plug_template_id=>wwv_flow_imp.id(18322135236001071802)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(18322135868746071802)
,p_plug_template_id=>wwv_flow_imp.id(18322135236001071802)
,p_name=>'Close'
,p_placeholder=>'CLOSE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(18322136114262071803)
,p_plug_template_id=>wwv_flow_imp.id(18322135236001071802)
,p_name=>'Create'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(18322136496547071803)
,p_plug_template_id=>wwv_flow_imp.id(18322135236001071802)
,p_name=>'Delete'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(18322136708368071803)
,p_plug_template_id=>wwv_flow_imp.id(18322135236001071802)
,p_name=>'Edit'
,p_placeholder=>'EDIT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(18322137073446071803)
,p_plug_template_id=>wwv_flow_imp.id(18322135236001071802)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(18322137353431071803)
,p_plug_template_id=>wwv_flow_imp.id(18322135236001071802)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(18322137626702071804)
,p_plug_template_id=>wwv_flow_imp.id(18322135236001071802)
,p_name=>'Sub Regions'
