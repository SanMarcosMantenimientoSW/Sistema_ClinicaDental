...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(18322100150483071788)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(18322100451693071788)
,p_plug_template_id=>wwv_flow_imp.id(18322100150483071788)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(18322100717156071788)
,p_plug_template_id=>wwv_flow_imp.id(18322100150483071788)
,p_name=>'Sort Order'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(18322101038264071788)
,p_plug_template_id=>wwv_flow_imp.id(18322100150483071788)
,p_name=>'Sub Regions'
