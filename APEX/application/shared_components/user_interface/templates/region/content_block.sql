...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(18322121739448071797)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(18322122025812071797)
,p_plug_template_id=>wwv_flow_imp.id(18322121739448071797)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(18322122323848071797)
,p_plug_template_id=>wwv_flow_imp.id(18322121739448071797)
,p_name=>'Change'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(18322122663927071797)
,p_plug_template_id=>wwv_flow_imp.id(18322121739448071797)
,p_name=>'Edit'
,p_placeholder=>'EDIT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(18322122949473071797)
,p_plug_template_id=>wwv_flow_imp.id(18322121739448071797)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(18322123247881071797)
,p_plug_template_id=>wwv_flow_imp.id(18322121739448071797)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(18322123518960071797)
,p_plug_template_id=>wwv_flow_imp.id(18322121739448071797)
,p_name=>'Sub Regions'
