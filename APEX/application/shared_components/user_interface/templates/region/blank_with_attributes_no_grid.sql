...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(18322094482127071786)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(18322094751920071786)
,p_plug_template_id=>wwv_flow_imp.id(18322094482127071786)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(18322095019095071786)
,p_plug_template_id=>wwv_flow_imp.id(18322094482127071786)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(18322095301040071786)
,p_plug_template_id=>wwv_flow_imp.id(18322094482127071786)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(18322095695880071786)
,p_plug_template_id=>wwv_flow_imp.id(18322094482127071786)
,p_name=>'Sub Regions'
