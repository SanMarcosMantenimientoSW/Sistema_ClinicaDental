...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(18322093018462071785)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(18322093361059071785)
,p_plug_template_id=>wwv_flow_imp.id(18322093018462071785)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(18322093657839071785)
,p_plug_template_id=>wwv_flow_imp.id(18322093018462071785)
,p_name=>'Next'
,p_placeholder=>'NEXT'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(18322093944227071785)
,p_plug_template_id=>wwv_flow_imp.id(18322093018462071785)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(18322094299515071786)
,p_plug_template_id=>wwv_flow_imp.id(18322093018462071785)
,p_name=>'Sub Regions'
