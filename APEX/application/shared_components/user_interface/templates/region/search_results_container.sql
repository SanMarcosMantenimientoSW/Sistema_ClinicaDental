...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(18322156995352071811)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(18322157218549071811)
,p_plug_template_id=>wwv_flow_imp.id(18322156995352071811)
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(18322157526986071811)
,p_plug_template_id=>wwv_flow_imp.id(18322156995352071811)
,p_name=>'Search Field'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(18322157840619071811)
,p_plug_template_id=>wwv_flow_imp.id(18322156995352071811)
,p_name=>'Sub Regions'
