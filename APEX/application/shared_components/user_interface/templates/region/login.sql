...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(18322154447373071810)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(18322154756555071810)
,p_plug_template_id=>wwv_flow_imp.id(18322154447373071810)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(18322155031249071810)
,p_plug_template_id=>wwv_flow_imp.id(18322154447373071810)
,p_name=>'Create'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(18322155308585071810)
,p_plug_template_id=>wwv_flow_imp.id(18322154447373071810)
,p_name=>'Edit'
,p_placeholder=>'EDIT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(18322155637051071811)
,p_plug_template_id=>wwv_flow_imp.id(18322154447373071810)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(18322155932040071811)
,p_plug_template_id=>wwv_flow_imp.id(18322154447373071810)
,p_name=>'Sub Regions'
