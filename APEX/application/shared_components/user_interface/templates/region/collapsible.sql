...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(18322111903307071793)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(18322112271156071793)
,p_plug_template_id=>wwv_flow_imp.id(18322111903307071793)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(18322112564401071793)
,p_plug_template_id=>wwv_flow_imp.id(18322111903307071793)
,p_name=>'Change'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(18322112836570071793)
,p_plug_template_id=>wwv_flow_imp.id(18322111903307071793)
,p_name=>'Close'
,p_placeholder=>'CLOSE'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(18322113141463071793)
,p_plug_template_id=>wwv_flow_imp.id(18322111903307071793)
,p_name=>'Copy'
,p_placeholder=>'COPY'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(18322113451932071793)
,p_plug_template_id=>wwv_flow_imp.id(18322111903307071793)
,p_name=>'Create'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(18322113735546071793)
,p_plug_template_id=>wwv_flow_imp.id(18322111903307071793)
,p_name=>'Edit'
,p_placeholder=>'EDIT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(18322114080750071794)
,p_plug_template_id=>wwv_flow_imp.id(18322111903307071793)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(18322114307510071794)
,p_plug_template_id=>wwv_flow_imp.id(18322111903307071793)
,p_name=>'Sort Order'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(18322114689526071794)
,p_plug_template_id=>wwv_flow_imp.id(18322111903307071793)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(18322114977372071794)
,p_plug_template_id=>wwv_flow_imp.id(18322111903307071793)
,p_name=>'Sub Regions'
