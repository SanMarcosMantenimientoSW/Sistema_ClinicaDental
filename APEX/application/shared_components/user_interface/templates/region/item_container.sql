...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(18322151954319071809)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(18322152226131071809)
,p_plug_template_id=>wwv_flow_imp.id(18322151954319071809)
,p_name=>'Item'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(18322152593712071809)
,p_plug_template_id=>wwv_flow_imp.id(18322151954319071809)
,p_name=>'Button End'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(18322152882247071810)
,p_plug_template_id=>wwv_flow_imp.id(18322151954319071809)
,p_name=>'Button Start'
