...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(18322149804553071808)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(18322150148328071808)
,p_plug_template_id=>wwv_flow_imp.id(18322149804553071808)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(18322150425113071809)
,p_plug_template_id=>wwv_flow_imp.id(18322149804553071808)
,p_name=>'Next'
,p_placeholder=>'NEXT'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(18322150764851071809)
,p_plug_template_id=>wwv_flow_imp.id(18322149804553071808)
,p_name=>'Sort Order'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(18322151016024071809)
,p_plug_template_id=>wwv_flow_imp.id(18322149804553071808)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(18322151384079071809)
,p_plug_template_id=>wwv_flow_imp.id(18322149804553071808)
,p_name=>'Sub Regions'
