...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(18322169439408071816)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(18322169742847071816)
,p_plug_template_id=>wwv_flow_imp.id(18322169439408071816)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(18322170005258071816)
,p_plug_template_id=>wwv_flow_imp.id(18322169439408071816)
,p_name=>'Tabs'
