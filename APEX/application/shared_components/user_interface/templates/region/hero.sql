...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(18322126368887071799)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(18322126624426071799)
,p_plug_template_id=>wwv_flow_imp.id(18322126368887071799)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(18322126908800071799)
,p_plug_template_id=>wwv_flow_imp.id(18322126368887071799)
,p_name=>'Next'
,p_placeholder=>'NEXT'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(18322127234456071799)
,p_plug_template_id=>wwv_flow_imp.id(18322126368887071799)
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(18322127538079071799)
,p_plug_template_id=>wwv_flow_imp.id(18322126368887071799)
,p_name=>'Sub Regions'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(18322127865274071799)
,p_plug_template_id=>wwv_flow_imp.id(18322126368887071799)
,p_name=>'Up'
,p_placeholder=>'UP'
,p_has_grid_support=>false
