...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(18322129842603071800)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(18322130144813071800)
,p_plug_template_id=>wwv_flow_imp.id(18322129842603071800)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(18322130463469071800)
,p_plug_template_id=>wwv_flow_imp.id(18322129842603071800)
,p_name=>'Sub Regions'
