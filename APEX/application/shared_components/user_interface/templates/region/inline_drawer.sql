...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(18322139847152071804)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(18322140159567071805)
,p_plug_template_id=>wwv_flow_imp.id(18322139847152071804)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(18322140428476071805)
,p_plug_template_id=>wwv_flow_imp.id(18322139847152071804)
,p_name=>'Close'
,p_placeholder=>'CLOSE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(18322140712066071805)
,p_plug_template_id=>wwv_flow_imp.id(18322139847152071804)
,p_name=>'Create'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(18322141097188071805)
,p_plug_template_id=>wwv_flow_imp.id(18322139847152071804)
,p_name=>'Delete'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(18322141309535071805)
,p_plug_template_id=>wwv_flow_imp.id(18322139847152071804)
,p_name=>'Edit'
,p_placeholder=>'EDIT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(18322141641442071805)
,p_plug_template_id=>wwv_flow_imp.id(18322139847152071804)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(18322141991883071805)
,p_plug_template_id=>wwv_flow_imp.id(18322139847152071804)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(18322142228108071805)
,p_plug_template_id=>wwv_flow_imp.id(18322139847152071804)
,p_name=>'Sub Regions'
