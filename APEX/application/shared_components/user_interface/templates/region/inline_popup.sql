...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(18322144421989071806)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(18322144739008071806)
,p_plug_template_id=>wwv_flow_imp.id(18322144421989071806)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(18322145012063071806)
,p_plug_template_id=>wwv_flow_imp.id(18322144421989071806)
,p_name=>'Close'
,p_placeholder=>'CLOSE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(18322145313802071807)
,p_plug_template_id=>wwv_flow_imp.id(18322144421989071806)
,p_name=>'Create'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(18322145652437071807)
,p_plug_template_id=>wwv_flow_imp.id(18322144421989071806)
,p_name=>'Delete'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(18322145960002071807)
,p_plug_template_id=>wwv_flow_imp.id(18322144421989071806)
,p_name=>'Edit'
,p_placeholder=>'EDIT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(18322146274635071807)
,p_plug_template_id=>wwv_flow_imp.id(18322144421989071806)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(18322146546589071807)
,p_plug_template_id=>wwv_flow_imp.id(18322144421989071806)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(18322146878179071807)
,p_plug_template_id=>wwv_flow_imp.id(18322144421989071806)
,p_name=>'Sub Regions'
