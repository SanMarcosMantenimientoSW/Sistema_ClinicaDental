...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(18322177168121071819)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(18322177437459071820)
,p_plug_template_id=>wwv_flow_imp.id(18322177168121071819)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(18322177776398071820)
,p_plug_template_id=>wwv_flow_imp.id(18322177168121071819)
,p_name=>'Close'
,p_placeholder=>'CLOSE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(18322178089737071820)
,p_plug_template_id=>wwv_flow_imp.id(18322177168121071819)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(18322178308059071820)
,p_plug_template_id=>wwv_flow_imp.id(18322177168121071819)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(18322178632863071820)
,p_plug_template_id=>wwv_flow_imp.id(18322177168121071819)
